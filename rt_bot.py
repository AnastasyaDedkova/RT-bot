...
Original file is located at
    https://colab.research.google.com/drive/11ezKGzBnzPhcRDFKhYVPb9AECviy0VO1
"""
...
def hacked_page_menu_inlinekeyboard():
  keyboard = [[InlineKeyboardButton('ВКонтакте', url='https://vhod.ru/vkontakte/parol/')],
              ...
              [InlineKeyboardButton('Инстаграм', url='https://vhod.ru/instagram/vzlomali/')]]
  return InlineKeyboardMarkup(keyboard)

def password_menu_inlinekeyboard():
  keyboard = [[InlineKeyboardButton('Советы эксперта', url='https://www.kaspersky.ru/blog/false-perception-of-it-security-passwords/6460/')],
...
def scam_menu_inlinekeyboard():
  keyboard = [[InlineKeyboardButton('Как распознать мошенника', url='https://fincult.info/article/kak-bystro-raspoznat-moshennika/')],
              [InlineKeyboardButton('Сообщить о мошенничестве', url='https://www.sberbank.ru/ru/person/dist_services/cybersecurity/report/')],
              [InlineKeyboardButton('Проверка телефона или сайта', url='https://www.sberbank.ru/ru/person/dist_services/cybersecurity/antifraud/')]]
  return InlineKeyboardMarkup(keyboard)

def social_menu_inlinekeyboard():
  keyboard = [[InlineKeyboardButton('Социальные сети', url='https://netmap.net/news/view/102/')],
...
def buy_menu_inlinekeyboard():
  keyboard = [[InlineKeyboardButton('Фишинг', url='https://fincult.info/article/bezopasnye-pokupki-v-internete/')],
              [InlineKeyboardButton('Интернет-магазины', url='https://www.sberbank.ru/ru/person/blog/buy_without_loss')],
              [InlineKeyboardButton('Сайты объявлений', url='https://www.sberbank.ru/ru/person/dist_services/cyber_blog/websites-ads')],
              [InlineKeyboardButton('Как ограничить расходы по карте', url='https://bankstoday.net/last-articles/na-zlo-moshennikam-kak-samomu-ustanovit-sutochnyj-limit-po-kartam-sberbanka')]]
  return InlineKeyboardMarkup(keyboard)
...
def public_menu_inlinekeyboard():
  keyboard = [[InlineKeyboardButton('Как зарегистрироваться', url='https://www.gosuslugi.ru/help/faq/login/1')],
              [InlineKeyboardButton('Защита от взлома', url='https://www.kaspersky.ru/blog/gosuslugi-ru-security/23371/')],
              [InlineKeyboardButton('Помощь пенсионерам', url='https://www.gosuslugi.ru/situation/pomoshch_pensioneram')],
              [InlineKeyboardButton('Осторожно:мошенники', url='https://www.gosuslugi.ru/help/news/2020_04_27_scammers')]]
  return InlineKeyboardMarkup(keyboard)

def mail_menu_inlinekeyboard():
  keyboard = [[InlineKeyboardButton('Защита от взлома', url='https://safe-surf.ru/users-of/article/335/')],
              [InlineKeyboardButton('Как бороться со спамом', url='https://www.kaspersky.ru/resource-center/threats/spam-phishing')],
              [InlineKeyboardButton('Письма мошенников', url='https://help.mail.ru/mail/security/letters/money')]]
  return InlineKeyboardMarkup(keyboard)

def video_menu_inlinekeyboard():
  keyboard = [[InlineKeyboardButton('Основы работы на компьютере', url='https://www.azbukainterneta.ru/guidelines/video/')],
...
def test_menu_inlinekeyboard():
  keyboard = [[InlineKeyboardButton('Кибербезопасность', url='https://www.sberbank.ru/common/img/uploaded/files/promo/marathon_cyber/#rec372913533')],
              [InlineKeyboardButton('Общение в сети', url='https://www.sberbank.ru/ru/person/dist_services/cybersecurity/education/pravila')],
              [InlineKeyboardButton('Защита от фишинга', url='https://www.sberbank.ru/ru/person/dist_services/cybersecurity/education/fish')],
              [InlineKeyboardButton('Безопасные покупки', url='https://www.sberbank.ru/ru/person/dist_services/cybersecurity_survey_shopping')]]
  return InlineKeyboardMarkup(keyboard)
